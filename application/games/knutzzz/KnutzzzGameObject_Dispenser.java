...
public class KnutzzzGameObject_Dispenser implements Updateable, Drawable
{
	...
	public KnutzzzGameObject_Dispenser(final Knutzzz parent)
	{
		...
		try
		{
			// TODO ImageIO is deprecated in this project
			this.lighthouseImage = ImageIO.read(new File("res/games/knutzzz/img/lighthouse.png").toURI().toURL());
		}
	...
	private void loadImages()
	{
		...
		// Try-Catch-Abfrage zur �berpr�fung, ob Bilddateien der Kanone
		// vorhanden sind
		try
		{
