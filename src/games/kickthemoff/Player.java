...
public class Player implements Drawable, Updateable {
	...
	public void draw(final Graphics2D g) {
		...
		g.fillOval((int) (this.x - 25 * this.scale), (int) (this.y - 25 * this.scale), (int) (50 * this.scale), (int) (50 * this.scale));
	}
	...
	public void update(final long elapsed) {
		...
		this.accelerationX -= Math.abs(this.accelerationX) > 0
		      ? this.accelerationX > 0 ? Player.SPEED_DECREASE_PER_SECOND * timefactor : -Player.SPEED_DECREASE_PER_SECOND * timefactor : 0;
		this.accelerationY -= Math.abs(this.accelerationY) > 0
		      ? this.accelerationY > 0 ? Player.SPEED_DECREASE_PER_SECOND * timefactor : -Player.SPEED_DECREASE_PER_SECOND * timefactor : 0;
		...
		if (len > this.g.getR() & !this.dying) {
			...
			new Thread() {
				...
				public void run() {
					...
					final waterSplash w = new waterSplash(Player.this.game, (int) Player.this.x - 25, (int) Player.this.y - 25);
