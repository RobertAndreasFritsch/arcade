...
//	int anglespeed = 0;
//
//	Image TankObject = Toolkit.getDefaultToolkit().getImage("res/games/tank/img/Tankred.png");
//	private Field field;
...
//
//	// ------------------------------------------------------------------Constructor
//	public Tank(Seat player, int x, int y, Field field, Tank[] tankArray, KeyRequest keys, MusicPlayer musicPlayer,
//			Game parent) {
//		this.player = player;
//		this.field = field;
//		this.keys = keys;
...
//
//				System.out.println("Kugel " + c + " von Spieler " + player + " mit der Position "
//						+ loadedBullet.getBulletPosX() + " | " + loadedBullet.getBulletPosY() + " erstellt.");
//
//				break;
//			}
//		}
...
//
//		// Kollision
//		int posx = (int) (TankPosX + Math.cos(Math.toRadians(angle)) * 16 * Math.signum(speed)) / 32;
//		int posy = (int) (TankPosY + Math.sin(Math.toRadians(angle)) * 16 * Math.signum(speed)) / 32;
//
