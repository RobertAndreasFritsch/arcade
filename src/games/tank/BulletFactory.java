...
public class BulletFactory {
	...
	public BulletFactory(final Game game, final Battleground battleground, final Tank[] tankArray,
			final Player[] player, SoundFactory soundFactory) {
		this.game = game;
	...
	public void newBullet(final Tank tank) {
		...
		if (this.bulletcounter[tank.player] < 5) {
			...
			soundFactory.newSound(new File("res/games/tankies/sounds/Samples/shoot.wav"), false, SoundFactory.Type.WAV);
		}
	}
