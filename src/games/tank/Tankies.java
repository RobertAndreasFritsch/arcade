...
public class Tankies extends MyGame {
	...
	public Tankies(final JPanel PANEL, final KeyRequest keys, final String[] args) {
		...
		battleground = new Battleground((int) (Math.random() * Battleground.settings.length), soundFactory);
	...
	public Tankies(final JPanel PANEL, final KeyRequest keys, final String[] args, final Player[] player) {
		super(PANEL, keys, args);
	...
	public Game getNextGame() {
		...
		return new Tankies(super.getPANEL(), super.getKEYS(), null, this.player);
	}
}
